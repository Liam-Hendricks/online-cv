    ...
    <Layout>
          ...
          <Carousel interval={null}>
            <Carousel.Item>
              <div className="carousel-img">
                <img src="../static/minesweeper/mine_image2.png" alt="First slide" />
              </div>
            ...
            <Carousel.Item>
              <div className="carousel-img">
                <img className="img-carousel" src="../static/minesweeper/mine_image3.png" alt="First slide" />
            ...
            <Carousel.Item>
              <div className="carousel-img">
                <img src="../static/minesweeper/mine_image1.png" alt="First slide" />
              </div>
              <Carousel.Caption >
                <h3>Help Menu</h3>
                <p>
                 Click on help to learn the rules
                </p>
              </Carousel.Caption>
            </Carousel.Item>
          </Carousel>
        ...
        <div className="right-container">
          <div className="right-text">
            ...
            This is one of my capstone projects after learning how to use react.
              ...
              <br />
              This project was challenging but once I figured out the main logic,
      ...
      <div className="left-container">
          <Carousel interval={null}>
            <Carousel.Item>
              <div className="carousel-img">
                <img src="../static/Itunes/itunes_image1.png" alt="First slide" />
              </div>
            ...
            <Carousel.Item>
              <div className="carousel-img">
                <img className="img-carousel" src="../static/Itunes/itunes_image2.png" alt="First slide" />
            ...
            <Carousel.Item>
              <div className="carousel-img">
                <img src="../static/Itunes/itunes_image3.png" alt="First slide" />
              </div>
              <Carousel.Caption >
      ...
      <section className="Drone-Flight-Planner">
        <div className="left-container">
            <Carousel interval={null}>
              <Carousel.Item>
                <div className="carousel-img">
                  <img src="../static/RPAS_app/drone_image2.png" alt="First slide" />
                </div>
              ...
              <Carousel.Item>
                <div className="carousel-img">
                  <img className="img-carousel" src="../static/RPAS_app/drone_image1.png" alt="First slide" />
              ...
              <Carousel.Item>
                <div className="carousel-img">
                  <img src="../static/RPAS_app/drone_image3.png" alt="First slide" />
                </div>
                <Carousel.Caption >
        ...
        <div className="right-container">
          ...
          <p>
              ...
              documents.
              <br />
              A user also has access to weather data using their gps
